//Do While Loops do-while Swimming 15 pts
...
//1. same
//2. Gallant stop swimming while Goofus swim for 1 min
//3. check the water temperature first
//4. dive in first
//5. Whileloop check the condition first. do while do the actions first then check the condition.
//6. Post-test: do-while loop pre-test: while loop